...
def initial_parameters():
    ...
    length_pers = 480
    width_pers = 1080
    srcps = np.float32([[(176,271), (17,472), (534,448), (416,267)]])
    dstps = np.float32([[(startx, starty), (startx, starty + width_pers), (startx + length_pers, starty + width_pers), (startx + length_pers, starty)]])
            ...
            if ret == True:
        	    ...
        	    #gray0 = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
                    ...
                    if ramp_control == True:
                        ...
                        aP[0] = aimLaneP[0] + LorR*roadWidth_ramp/2
                        aP[1] = aimLaneP[1]
...
def RLcallback(stop_judge):
    ...
    if stop_judge.show_time >1 and stop_judge.red_or_green ==1:
        ramp_control = True
    if stop_judge.exist == 1 and stop_judge.red_or_green ==0:
        stop_judge_local = True
    else:
        stop_judge_loacl = False
