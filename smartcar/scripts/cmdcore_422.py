...
def initial_parameters():
    ...
    intrinsicMat = np.array([[1322.000, 0, 945.4288],
                            [0, 1324.100, 594.5997],
                            [0, 0, 1]])

    distortionCoe = np.array([0.0358, -0.0557, 0, 0, 0])
    
    startx = 120
    starty = 50
    length_pers = 400
    width_pers = length_pers
    srcps = np.float32([[(200,239), (70,345), (628,349), (445,228)]])  ##(191,192), (32,278), (620,282), (450,190) #(196,213), (5,374), (634,370), (458,203) 
...
##        part_A = 1
    ...
    if light_msg.red_or_green ==2 :   ##changeable
